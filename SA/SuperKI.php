        ...
        <nav class="col span_10_of_12 aligned right">
            <ul class="mainmenu">
                ...
                <li class="dropdown">
					...
					<ul>
						<li><a href="agendaSA/SuperKI/index.php">Agenda</a></li>
						<li><a href="laporanSA/SuperKI/post.php">Laporan</a></li>
                    </ul>
                </li>
    ...
    <div class="content section">
        <!-- Blog Roll -->
		 ...
		 <div class="col span_3_of_12">
            ...
            <div class="col span_3_of_12">
                <a href="agendaSA/SuperKI/index.php" class="img">
				...
				<h4><a href="agendaSA/SuperKI/index.php">Agenda</a></h4>
                <nav class="categories">
                </nav>
                
            </div>
            <div class="col span_3_of_12">
                <a href="laporanSA/SuperKI/post.php" class="img">
                ...
                <h4><a href="laporanSA/SuperKI/post.php">Laporan</a></h4>
                <nav class="categories">
                </nav>
            </div>
