...
<div class="wrapper">
    ...
    <div class="heading section">
        <h1><img src="" alt=""> Welcome Super Admin</h1>
        <hr>
    </div>
...
<button onclick="window.location='menteri.php'" class="btn btn-primary disabled">Matriks Menteri</button>
<br>
<br>
...
<table class="tablesorter-bootstrap">
	...
	<tbody>
		<?php
			...
			$i=1;
			$a = $conn -> prepare("SELECT * FROM mtk_post where id_direktorat = 3");
			$a -> execute();
			while($age = $a->fetch())
			{        
		?>
