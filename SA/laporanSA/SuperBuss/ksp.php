...
<h2>DATA MATRIKS KSP APTIKA</h2>
<br>
<hr>
<button onclick="window.location='post.php'" class="btn btn-primary disabled">Matriks Pos</button> </hr>
<button onclick="window.location='rpjmn.php'" class="btn btn-primary">Matriks RPJMN</button>
<button onclick="window.location='ksp.php'" class="btn btn-primary disabled">Matriks KSP</button>
...
<table class="tablesorter-bootstrap">
	...
	<tbody>
		<?php
			...
			$i=1;
			$a = $conn -> prepare("SELECT * FROM mtk_ksp where id_direktorat = 3");
			$a -> execute();
			while($age = $a->fetch())
			{        
		?>
			<tr>
				...
				<td><?php echo $age['data_pendukung']; ?></td>
			</tr>
