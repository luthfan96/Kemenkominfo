        ...
        <nav class="col span_10_of_12 aligned right">
            <ul class="mainmenu">
                ...
                <li class="dropdown">
					...
					<ul>
						<li><a href="agendaSA/SuperPI/index.php">Agenda</a></li>
						<li><a href="laporanSA/SuperPI/post.php">Laporan</a></li>
                    </ul>
                </li>
        ...
        <!-- Blog Roll -->
         <div class="blogroll">
			...
			<div class="col span_3_of_12">
                ...
                <a href="agendaSA/SuperPI/index.php" class="img">
                ...
                <h4><a href="agendaSA/SuperPI/index.php">Agenda</a></h4>
                <nav class="categories">
                </nav>
                
            </div>
            <div class="col span_3_of_12">
                <a href="laporanSA/SuperPI/post.php" class="img">
                ...
                <h4><a href="laporanSA/SuperPI/post.php">Laporan</a></h4>
                <nav class="categories">
                </nav>
