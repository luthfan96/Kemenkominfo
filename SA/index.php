    ...
    <div class="heading section">
        ...
        <div class="section portfolio">
            <div class="work">
                ...
                <div class="mask">
                    <a href="Supersekre.php">Sekretaris Ditjen Aptika</a>
                </div>
            </div>
            <div class="work">
                <img src="../Include/hpInclude/images/e-goverment.png" alt="">
                <div class="mask">
                    <a href="Supergover.php">e-Goverment</a>
                </div>
            </div>
            <div class="work">
                <img src="../Include/hpInclude/images/e-business-01.jpg" alt="">
                <div class="mask">
                    <a href="Superbuss.php">e-Business</a>
                </div>
            </div>
		...
		<div class="work">
                ...
                <div class="mask">
                    <a href="SuperPI.php">Pemberdayaan Informatika</a>
                </div>
            </div>
            <div class="work">
                <img src="../Include/hpInclude/images/pemberdayaan industri informatika.png" alt="">
                <div class="mask">
                    <a href="SuperPII.php">Pemberdayaan Industri Informatika</a>
                </div>
            </div>
            <div class="work">
                <img src="../Include/hpInclude/images/secuarity.png" alt="">
                <div class="mask">
                    <a href="SuperKI.php">Keamanan Informasi</a>
                </div>
            </div>
		</div>
        <!-- /.portfolio -->
